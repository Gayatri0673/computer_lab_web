...
$project_query = "SELECT * FROM me_lab_3 WHERE accession_no ='$accession_no'";
...
if (isset($_POST['edit_btn'])) {
    ...
    $query_update ="UPDATE me_lab_3 SET 
                        ...
                        <div class="container-p-x">
                            <div class="card my-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="edit_me_lab_3.php" method="POST">
                                        <div class="row mt-3">
                                            <div class="col-lg-6">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a href="./me_lab_3.php" class="btn btn-secondary">Back</a>
                                        </div>
                                    </form>
