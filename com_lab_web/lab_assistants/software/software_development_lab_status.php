...
if (isset($_POST['save_status'])) {
    ...
    $update_query = "
INSERT INTO software_development_lab_status
...
";
    ...
    if ($run_update) {
        echo "<script>window.location='software_development_lab_status.php';</script>";
    } else {
        echo "<script>window.location='software_development_lab_status.php';</script>";
    }
}
...
<body>
    ...
    FROM software_development_lab nl
    LEFT JOIN software_development_lab_status s ON nl.`Sr.No` = s.`Sr.No`
");
