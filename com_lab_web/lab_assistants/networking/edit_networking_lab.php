...
$project_query = "SELECT * FROM networking_lab WHERE accession_no ='$accession_no'";
        ...
        <body>
            <div class="layout-wrapper layout-content-navbar">
                <div class="layout-container">
                    <!-- Sidebar -->
                    <?php              include '../../common/networking_lab_sidebar.php';
?>
                    <!-- / Sidebar -->
                        ...
                        <div class="container-p-x">
                            <div class="card my-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="edit_networking_lab.php" method="POST">
                                        <div class="row mt-3">
                                            <div class="col-lg-6">
