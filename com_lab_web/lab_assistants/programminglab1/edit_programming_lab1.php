...
$project_query = "SELECT * FROM programming_lab1 WHERE accession_no ='$accession_no'";
...
if (isset($_POST['edit_btn'])) {
    ...
    $query_update = "UPDATE programming_lab1 SET 
        ...
        <body>
            <div class="layout-wrapper layout-content-navbar">
                <div class="layout-container">
                    <!-- Sidebar -->
                    <?php include '../../common/programming_lab1_sidebar.php';
                    ?>
                    <!-- / Sidebar -->
                        ...
                        <div class="container-p-x">
                            <div class="card my-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="edit_programming_lab1.php" method="POST">
                                        <div class="row mt-3">
                                            <div class="col-lg-6">
