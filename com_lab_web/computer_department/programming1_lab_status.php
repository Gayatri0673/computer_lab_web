...
if (isset($_POST['save_status'])) {
    ...
    $update_query = "
INSERT INTO programming1_lab_status
...
";
    ...
    if ($run_update) {
        echo "<script>window.location='programming1_lab_status.php';</script>";
    } else {
        echo "<script>window.location='programming1_lab_status.php';</script>";
    }
}
...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-p-x flex-grow-1 container-p-y">
                        <h4 class="text-muted fw-bold py-3 mb-4">Programming LAB 1</h4>
    ...
    FROM programming_lab1 nl
    LEFT JOIN programming1_lab_status s ON nl.`sr.no.` = s.`sr.no.`
");
