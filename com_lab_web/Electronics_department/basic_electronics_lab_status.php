...
if (isset($_POST['save_status'])) {
    ...
    $update_query = "
INSERT INTO basic_electronics_lab_status
...
";
    ...
    if ($run_update) {
        echo "<script>window.location=' basic_electronics_lab_status.php';</script>";
    } else {
        echo "<script>window.location=' basic_electronics_lab_status.php';</script>";
    }
}
...
<body>
    ...
    FROM  basic_electronics_lab nl
    LEFT JOIN  basic_electronics_lab_status s ON nl.`sr.no.`= s.`sr.no.`
");
