...
$total_query = "
SELECT
IFNULL((SELECT COUNT(*) FROM basic_electrical_engineering_laboratory),0) +
IFNULL((SELECT COUNT(*) FROM power_electronics_laboratory),0)
AS total_pc
";
...
$working_query = "
SELECT
IFNULL((SELECT COUNT(*) FROM basic_electrical_engineering_laboratory WHERE Maintenance='No'),0) +
IFNULL((SELECT COUNT(*) FROM power_electronics_laboratory WHERE Maintenance='No'),0)
AS working_pc
";
...
$defected_query = "
SELECT
IFNULL((SELECT COUNT(*) FROM basic_electrical_engineering_laboratory WHERE Remark='Defected'),0) +
IFNULL((SELECT COUNT(*) FROM power_electronics_laboratory WHERE Remark='Defected'),0)
AS defected_pc
";
...
$maintenance_query = "
SELECT
IFNULL((SELECT COUNT(*) FROM basic_electrical_engineering_laboratory WHERE Maintenance='Yes'),0) +
IFNULL((SELECT COUNT(*) FROM power_electronics_laboratory WHERE Maintenance='Yes'),0)
AS maintenance_pc
";
...
<body>
  ...
  <div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
      <!-- Menu -->
      <?php
        include '../common/electrical_hod_sidebar.php';
      ?>
      <!-- / Menu -->
      <!-- Layout container -->
