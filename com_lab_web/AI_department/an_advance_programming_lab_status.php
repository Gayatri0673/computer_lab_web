...
if (isset($_POST['save_status'])) {
    ...
    $update_query = "
INSERT INTO an_advance_programming_lab_status
...
";
    ...
    if ($run_update) {
        echo "<script>window.location='an_advance_programming_lab_status.php';</script>";
    } else {
        echo "<script>window.location='an_advance_programming_lab_status.php';</script>";
    }
}
...
<body>
    ...
    FROM an_advance_programming_lab nl
    LEFT JOIN an_advance_programming_lab_status s ON nl.`sr.no.`= s.`sr.no.`
");
