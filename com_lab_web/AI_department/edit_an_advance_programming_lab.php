...
$accession_no = isset($_GET['accession_no']) ? trim($_GET['accession_no']) : null;
$project_query = "SELECT * FROM an_advance_programming_lab WHERE accession_no ='$accession_no'";
...
if (isset($_POST['edit_btn'])) {
    ...
    $query_update ="UPDATE an_advance_programming_lab SET 
                        ...
                        <div class="container-p-x">
                            <div class="card my-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="edit_an_advance_programming_lab.php" method="POST">
                                        <div class="row mt-3">
                                            <div class="col-lg-6">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a href="./AN_advance_programming_lab.php" class="btn btn-secondary">Back</a>
                                        </div>
                                    </form>
