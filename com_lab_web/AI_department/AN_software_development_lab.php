...
if (isset($_POST['delete_btn'])) {
    ...
    $lab_query = "DELETE FROM an_software_development_lab WHERE accession_no ='$delete_id'";
                        ...
                        <div class="card">
                            <div class="row">
                                ...
                                <div class="col-lg-6 d-flex justify-content-end">
                                    ...
                                    <a href="./add_an_software_development_lab.php">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            ...
                                                            <a href="./edit_an_software_development_lab.php?accession_no=<?php echo $project_row["accession_no"]; ?>" class="text-white">
