                        ...
                        <div class="card">
                            <div class="row">
                                ...
                                <div class="col-lg-6 d-flex justify-content-end">
                                    ...
                                    <a href="./add_AN-04_advance_programming_lab.php">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <a href="AI_show.php?lab=an_advance_programming_lab&accession_no=<?= $project_row['accession_no']; ?>">
                                                                <button class="btn rounded-pill btn-success me-1">Show</button>
                                                            </a>
                                                            </a>
                                                            <a href="./edit_AN-04_advance_programming_lab.php?accession_no=<?php echo $project_row["accession_no"]; ?>" class="text-white">
