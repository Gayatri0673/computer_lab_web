...
if (isset($_POST['edit_btn'])) {
    ...
    if ($query_update_run) {
        echo 'Data updated';
        header("Location: AN-03_software_development_lab.php");
    } else {
                        ...
                        <div class="container-p-x">
                            <div class="card my-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="edit_AN-03_software_development_lab.php" method="POST">
                                        <div class="row mt-3">
                                            <div class="col-lg-6">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a href="./AN-03_software_development_lab.php" class="btn btn-secondary">Back</a>
                                        </div>
                                    </form>
