...
IFNULL((SELECT COUNT(*) FROM 	an_software_development_lab),0) +
IFNULL((SELECT COUNT(*) FROM an_advance_programming_lab),0)
AS total_pc
";
...
$working_query = "
SELECT
IFNULL((SELECT COUNT(*) FROM 	an_software_development_lab WHERE Maintenance='No'),0) +
IFNULL((SELECT COUNT(*) FROM an_advance_programming_lab WHERE Maintenance='No'),0)
AS working_pc
";
...
$defected_query = "
SELECT
IFNULL((SELECT COUNT(*) FROM 	an_software_development_lab WHERE Remark='Defected'),0) +
IFNULL((SELECT COUNT(*) FROM an_advance_programming_lab WHERE Remark='Defected'),0)
AS defected_pc
";
...
$maintenance_query = "
SELECT
IFNULL((SELECT COUNT(*) FROM 	an_software_development_lab WHERE Maintenance='Yes'),0) +
IFNULL((SELECT COUNT(*) FROM an_advance_programming_lab WHERE Maintenance='Yes'),0)
AS maintenance_pc
";
