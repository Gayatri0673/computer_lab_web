...
if (isset($_POST['save_status'])) {
    ...
    $update_query = "
INSERT INTO an_software_development_lab_status
...
";
    ...
    if ($run_update) {
        echo "<script>window.location='an_software_development_lab_status.php';</script>";
    } else {
        echo "<script>window.location='an_software_development_lab_status.php';</script>";
    }
}
...
<body>
    ...
    FROM an_software_development_lab nl
    LEFT JOIN an_software_development_lab_status s ON nl.`sr.no.`= s.`sr.no.`
");
