...
if (isset($_POST['delete_btn'])) {
    ...
    $lab_query = "DELETE FROM an_programming_lab2 WHERE accession_no ='$delete_id'";
    $lab_query_run = mysqli_query($conn, $lab_query);
    if ($lab_query_run) {
        header("Location: an_programming_lab2.php");
    } else {
        header("Location: an_programming_lab2.php");
    }
}
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-p-x flex-grow-1 container-p-y">
                        <h4 class="text-muted fw-bold py-3 mb-4">Programming Lab2</h4>
                        ...
                        <div class="card">
                            <div class="row">
                                ...
                                <div class="col-lg-6 d-flex justify-content-end">
                                    ...
                                    <a href="./add_an_programming_lab2.php">
                                        <button type="button" class="btn btn-primary m-4">ADD+</button>
                                    </a>
                                     <a href="./an_programming_lab2_status.php">
                            ...
                            <?php
                            $conn = mysqli_connect("localhost", "root", "", "computer");
                            $query = "SELECT * FROM an_programming_lab2";
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <a href="show.php?lab=an_programming_lab2&accession_no=<?= $project_row['accession_no']; ?>">
                                                                <button class="btn rounded-pill btn-success me-1">Show</button>
                                                            </a>
                                                            </a>
                                                            <a href="./edit_an_programming_lab2.php?accession_no=<?php echo $project_row["accession_no"]; ?>" class="text-white">
                                                                <button type="button" class="btn rounded-pill btn-primary">
                                                                    <i class="bx bx-edit-alt me-1"></i> Edit
                                                                </button>
                                                            </a>

                                                            <form action="an_programming_lab2.php" method="POST" class="d-lg-inline">
