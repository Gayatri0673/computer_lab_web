...
<head>
  ...
  <style>
    ...
    .growth-circle {
      ...
      height: 100px;
      border-radius: 50%;
      background: conic-gradient(#5a6ff0 78%, #ddd 0%);
      display: flex;
      align-items: center;
                    ...
                    <div
                      ...
                      <div
                        ...
                        <div class="mt-sm-auto">
                          <small
                            class="text-success text-nowrap fw-semibold"><i class="bx bx-chevron-up"></i> 68.2%</small>
                ...
                <ul class="p-0 m-0">
                  <li class="d-flex mb-4 pb-1">
                    <div class="avatar flex-shrink-0 me-3">
                      <span
                        class="avatar-initial rounded bg-label-primary"><i class="bx bx-mobile-alt"></i></span>
                    </div>
                    <div
                  ...
                  <li class="d-flex mb-4 pb-1">
                    <div class="avatar flex-shrink-0 me-3">
                      <span
                        class="avatar-initial rounded bg-label-success"><i class="bx bx-closet"></i></span>
                    </div>
                    <div
                      class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                      <div class="me-2">
                  ...
                  <li class="d-flex">
                    <div class="avatar flex-shrink-0 me-3">
                      <span
                        class="avatar-initial rounded bg-label-secondary"><i class="bx bx-football"></i></span>
                    </div>
                    <div
                      class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                      <div class="me-2">
  ...
  <script>
    ...
    new Chart(document.getElementById('revenueChart'), {
      ...
      data: {
        ...
        datasets: [{
            label: '2021',
            data: [12, 7, 10, 15, 11, 9, 8],
            backgroundColor: '#5a6ff0'
          },
          {
            label: '2020',
            data: [-10, -12, -8, -15, -9, -11, -10],
